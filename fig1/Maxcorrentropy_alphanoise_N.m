...
%% 
delta = sqrt(0.5);  
Gsnrdb = [-20 : 5: -10];    %GSNR are -10£¬-15 and -20dB
epsilon = 0;
t = 0:0.25:32;  
nSample = length(t);         % samples number 
N = 5;
...
for ii = 1:L
    ...
    for jj = 1: nloop
        ...
        for k = 1:1:N
            ...
            %*************  Signal + noise  ***********************
            RX(:,k) = rxSignal + noise' ;  % received signals in H1 
...
leg = legend('GSNR = -20dB,{\it N} = 256','GSNR = -15dB,{\it N} = 256','GSNR = -10dB,{\it N} = 256',...
             'GSNR = -20dB,{\it N} = 128','GSNR = -15dB,{\it N} = 128','GSNR = -10dB,{\it N} = 128');         
